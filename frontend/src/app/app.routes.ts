...
import { SalonEditComponent } from './pages/salon-edit/salon-edit.component'; // <-- We will create this
...
export const routes: Routes = [
  ...
  { path: 'salons/:id/edit', component: SalonEditComponent }, // <-- ADD THIS ROUTE
];
